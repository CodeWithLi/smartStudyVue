<script setup>
import { ref } from 'vue'
import { editPass } from '@/api/user.js'
...
const checkDifferent = (rule, value, callback) => {
  // 校验新密码和原密码不能一样
  if (value === pwdForm.value.oldPass) {
...
const checkSameAsNewPwd = (rule, value, callback) => {
  // 校验确认密码必须和新密码一样
  if (value !== pwdForm.value.newPass) {
      ...
      <el-col>
        ...
        >
          ...
          <el-form-item label="原密码" prop="oldPass">
            <el-input v-model="pwdForm.oldPass" show-password></el-input>
          </el-form-item>
          <el-form-item label="新密码" prop="newPass">
            <el-input v-model="pwdForm.newPass" show-password></el-input>
          </el-form-item>
          <el-form-item label="确认密码" prop="rePass">
            <el-input v-model="pwdForm.rePass" show-password></el-input>
          </el-form-item>
          <el-form-item>
