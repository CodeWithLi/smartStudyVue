<script setup lang="ts">
              ...
              if (chunkData.choices[0].delta.content) {
                if (!messageList.value[messageList.value.length - 1].receive) {
                  ...
                  messageList.value[messageList.value.length - 1].receive =
                    chunkData
                  messageList.value[messageList.value.length - 1].loading =
                    false
                } else {
                  const lastMessage =
                    messageList.value[messageList.value.length - 1]?.receive
                  if (lastMessage && lastMessage.choices[0].delta.content) {
                    lastMessage.choices[0].delta.content +=
  ...
  <template>
    <div id="layout" class="theme-cyan">
      <!-- Sidebar -->
      <div
        class="navigation navbar justify-content-center py-xl-4 py-md-3 py-0 px-3"
      >
        ...
        <div
          class="nav flex-md-column nav-pills flex-grow-1"
          role="tablist"
          aria-orientation="vertical"
        >
          <a
            class="mb-xl-3 mb-md-2 nav-link active"
            data-toggle="pill"
            href="#"
            role="tab"
          >
          ...
          <a
            class="mb-xl-3 mb-md-2 nav-link d-none d-sm-block flex-grow-1"
            data-toggle="pill"
            href="#"
            role="tab"
          >
          ...
          <a
            class="mt-xl-3 mt-md-2 nav-link d-none d-sm-block"
            href="#"
            role="tab"
          >
        ...
        <button
          type="submit"
          class="btn sidebar-toggle-btn shadow-sm"
          @click="handleMenu"
        >
        ...
        <div class="tab-content">
          ...
          >
            <div class="d-flex justify-content-between align-items-center mb-4">
              ...
              <div>
                <button class="btn btn-dark" type="button" @click="handleAdd">
                  New Chat
                </button>
              </div>
            </div>
                  ...
                  <div class="message-body">
                    ...
                    >
                      <div class="message-content border p-3">
                        ...
                        <div
                          class="attachment"
                          v-show="item.send.messages[0].fileName"
                          @click="handleBackDoc"
                        >
                          <div class="media mt-2">
                            ...
                            <div class="media-body overflow-hidden">
                              <h6 class="text-truncate mb-0">
                                {{ item.send.messages[0].fileName }}
                              </h6>
                              <span class="file-size">{{
                                item.send.messages[0].fileSize
                              }}</span>
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="message-body">
                    ...
                    <div class="message-row d-flex align-items-center">
                      <div class="message-content p-3">
                        <v-md-preview
                          :text="
                            item.receive.choices[0].message
                              ? item.receive.choices[0].message.content
                              : item.receive.choices[0].delta.content
                          "
                        ></v-md-preview>
                      </div>
                    </div>
